...
function c(t, e) {
  if ((undefined, (t = o_19(t, e < 0 ? 0 : 0 | e)), !true))
...
function update(kkk, t) {
  ...
  if (
    ((kkk.total_len += c),
    0 == kkk.memsize &&
      (kkk.memory = o ? "" : r ? new Uint8Array(32) : new i_update(32)),
    kkk.memsize + c < 32)
  )
    return (
      o
...
function s_this(t, k) {
  ...
  if (k)
    return (
      (k._a00 = 65535 & t), (k._a16 = t >>> 16), (k._a32 = 0), (k._a48 = 0), k
    );
  return (
    (this._a00 = 65535 & t),
    (this._a16 = t >>> 16),
...
function Bt(t) {
  ...
  function b(n) {
    ...
    for (var p = {}, d = 0; d < s; d++) {
      var m = i_Bt(a_slice(t, o + u + d * E, o + u + (d + 1) * E)),
        y = i_Bt(
          a_slice(t, o + u + s * E + d * E, o + u + s * E + (d + 1) * E)
        ),
        g = r(m),
        v = r(y);
      p[g] = v;
